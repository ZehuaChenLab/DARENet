"""
Codes from https://github.com/zlckanata/DeepGlobe-Road-Extraction-Challenge
"""
...
class DLinkNet(nn.Module):
    def __init__(self, img_size=1024, num_classes=1, num_channels=3):
