...
class CPSSNet(nn.Module):
    def __init__(self,
        ...
        self.backbone = timm.create_model(model_name=backbone_name, features_only=True,pretrained=pretrained, 
                                          ...
                                          pretrained_cfg_overlay=dict(file="/home/smart/Road/weights/convnext_tiny.in12k_ft_in1k_384.bin"))
    ...
    def forward(self, x,imagename=None):
        ...
        res = F.interpolate(res, size=self.img_size, mode='bilinear', align_corners=True)
        return res
