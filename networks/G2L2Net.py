...
class G2L2Net(nn.Module):
    def __init__(self, img_size=1024, num_classes=1):
        super(G2L2Net, self).__init__()
        ...
        self.c1 = G2L2Attention(filters[0])
        self.c2 = G2L2Attention(filters[1])
        self.c3 = G2L2Attention(filters[2])
        self.c4 = G2L2Attention(filters[3])
...
if __name__ == '__main__':
    ...
    net = G2L2Net(img_size=256)
    summary(net, input_size=(1, 3, 256,256))
    macs, params = get_model_complexity_info(net, (3, 256,256), print_per_layer_stat=False)
    print(macs, params)
